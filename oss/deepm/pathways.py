...
class Pathway(object):
    ...
    def calcInputRczDimsToProduceOutputFmsOfCompatibleDims(self, thisPathWayKernelDims, dimsOfOutputFromPrimaryPathway):
        ...
        for rcz_i in xrange(3) :
            rczDimsOfOutputOfPathwayShouldBe[rcz_i] = \
                int(ceil(rczDimsOfOutputFromPrimaryPathway[rcz_i]/(1.0*self.subsFactor()[rcz_i])))
            rczDimsOfInputToPathwayShouldBe[rcz_i] = recFieldAtEndOfPathway[rcz_i] + \
                rczDimsOfOutputOfPathwayShouldBe[rcz_i] - 1
