...
class CreateModelSessionParameters(object) :
    ...
    def __init__(   self,
        ...
        self.receptiveFieldNormal = \
            calculateReceptiveFieldDimensionsFromKernelsDimListPerLayerForFullyConvCnnWithStrides1(self.kernDimPerLayerNormal) 
        ...
        if not self.useSubsampledBool :
            ...
            # kernDimSubsampled was specified. Now it's going to be tricky to make sure everything alright.
                ...
                self.receptiveFieldSubsampled = \
                    calculateReceptiveFieldDimensionsFromKernelsDimListPerLayerForFullyConvCnnWithStrides1(\
                                                                                self.kernDimPerLayerSubsampled)
        ...
        assert len(self.kernelDimensionsFirstFcLayer) == 3 and (False not in [ dim > 0 for dim in \
    ...
    def printParametersOfThisSession(self) :
        ...
        logPrint("Dimensions of Kernels in the 1st FC layer (Classif. layer if no hidden FCs used) = " + \
                                        str(self.kernelDimensionsFirstFcLayer))
