...
class TrainSessionParameters(object) :
    ...
    def __init__(self,
        ...
        self.providedWeightMapsToSampleForEachCategoryTraining = True if \
                self.forEachSamplingCategory_aListOfFilepathsToWeightMapsOfEachPatientTraining else False 
        ...
        self.providedWeightMapsToSampleForEachCategoryValidation = True if \
            self.forEachSamplingCategory_aListOfFilepathsToWeightMapsOfEachPatientValidation else False 
        ...
        self.saveMultidimensionalImageWithAllFmsVal = saveMultidimensionalImageWithAllFmsVal if \
            saveMultidimensionalImageWithAllFmsVal <> None else False
        ...
        #Output:
        #Given by the config file, and is then used to fill filepathsToSavePredictionsForEachPatient and 
        # filepathsToSaveFeaturesForEachPatient.
    ...
    def printParametersOfThisSession(self) :
        ...
        logPrint("Paths to weight-maps for sampling of each category = " + \
                 str(self.forEachSamplingCategory_aListOfFilepathsToWeightMapsOfEachPatientTraining))
        ...
        logPrint("Paths to weight-maps for sampling of each category = " + \
                 str(self.forEachSamplingCategory_aListOfFilepathsToWeightMapsOfEachPatientValidation))
