...
class TestSessionParameters(object) :
    ...
    def __init__(self,
        ...
        #and is then used to fill filepathsToSavePredictionsForEachPat and filepathsToSaveFeaturesForEachPat.
        #predictions
        ...
        self.filepathsToSavePredictionsForEachPat = None #Filled by call to self.makeFilepathsForPredictionsAndFeatures()
        #features:
        self.saveIndividualFmImages = saveIndividualFmImages if saveIndividualFmImages <> None else False
        self.saveMDImgWithAllFms = saveMDImgWithAllFms if \
                                    saveMDImgWithAllFms <> None else False
        self.indicesOfFmsToVisualisePerPathwayAndLayer = [item if item <> None else [] for item in \
                                                          indicesOfFmsToVisualisePerPathwayAndLayer]
        self.filepathsToSaveFeaturesForEachPat = None #Filled by call to self.makeFilepathsForPredictionsAndFeatures()
    ...
    def _makeFilepathsForPredictionsAndFeatures(self,
        ...
        self.filepathsToSavePredictionsForEachPat = []
        self.filepathsToSaveFeaturesForEachPat = []
        ...
        if self.namesToSavePredictionsAndFeatures <> None :
            for case_i in xrange(self.numberOfCases) :
                ...
                self.filepathsToSavePredictionsForEachPat.append( filepathForCasePrediction )
                filepathForCaseFeatures = absPathToFolderForFeaturesFromSession + "/" + \
                    self.namesToSavePredictionsAndFeatures[case_i]
                self.filepathsToSaveFeaturesForEachPat.append( filepathForCaseFeatures )
    ...
    def printParametersOfThisSession(self) :
        ...
        logPrint("Paths where to save predictions per case = " + str(self.filepathsToSavePredictionsForEachPat))
        ...
        logPrint("Save all requested FMs in one 4D image = " + str(self.saveMDImgWithAllFms))
        if self.saveMDImgWithAllFms :
        ...
        logPrint("Save Feature Maps at = " + str(self.filepathsToSaveFeaturesForEachPat))
